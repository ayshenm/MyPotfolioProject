    ...
    <MotionViewport variants={varSlide("left")} className="container mb-28">
     <Title className="w-[28rem] ml-auto mr-auto mb-20">Experience</Title>
      ...
      <div className="px-5 lg:custom-px relative">
        <div
          className={cn(
            "shadow-md shadow-indigo-500/50 flex justify-center relative border mx-auto w-[16rem] py-3 px-2 border-primary rounded-xl gap-x-4 lg:gap-x-10 mb-20  after:bg-cyan-500/10 after:block after:absolute after:top-[7px] after:translate-x-0 after:left-2 after:w-[40%] after:h-[70%] after:rounded-xl after:z-10 after:transition-transform after:duration-300",
            {
